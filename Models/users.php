...
class Users {
  ...
  public function find($id) // Procura usuário pelo id
  {
  ...
  public function find($name) // Procura usuário pelo nome
  {
  ...
  public function find($courses_id) // Procura usuário pelo id do curso
  {
